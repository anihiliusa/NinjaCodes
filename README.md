...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//bool UseEquityStop = true;            // използвайте процентния риск
//double TotalEquityRisk = 10;         // риск като процент от депозита
//bool UseTrailingStop = FALSE;       // използвайте плаващ стоп
//bool UseTimeOut = FALSE;           // използвайте анулиране на поръчка по време
//double MaxTradeOpenHours = 48.0;  // след колко часа да анулирам висящи поръчки
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//double Stoploss   = 400;          // 
//double TrailStart = 400;         //
//double TrailStop  = 400;        //
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
double PriceTarget, StartEquity, BuyTarget, SellTarget ;
double AveragePrice, SellLimit, BuyLimit ;
double LastBuyPrice, LastSellPrice, Spread;
bool flag;
string EAName = "Nikolay Muskov 0898822909";
...
int AcctNbr =  21638247;                 // <-- напишете тук номера на оторизираната сметка // пример   21638247
         ...
         if(PrevCl > CurrCl)
           {
            ...
            //HHHHHHHH~~~~~~~~~~~~~ RSI ~~~~~~~~~~HHHHHHHHH~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            if(iRSI(NULL, PERIOD_H1, 14, PRICE_CLOSE, 1) < 30.0)        // < 20/2080
              {
